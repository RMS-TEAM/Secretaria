...
CREATE TABLE `Encuesta Docentes` (
		`Año` DATE NOT NULL, 
		`Código DANE` CHAR(12) NOT NULL, 
		`ID` INTEGER NOT NULL, 
		`Código Sede` CHAR(5) NOT NULL, 
...
CREATE TABLE `Encuesta Estudiantes` (
		`Año` DATE NOT NULL, 
		`Código DANE` CHAR(12) NOT NULL, 
		`ID` INTEGER NOT NULL, 
		`Código Sede` CHAR(5) NOT NULL, 
...
CREATE TABLE `Expectativas Docentes` (
		`Año` DATE NOT NULL, 
		`Expectativa Académica` DOUBLE, 
		`Comunicación` DOUBLE, 
		`Participación` DOUBLE, 
		`Seguridad y Respeto` DOUBLE, 
		`Código DANE` CHAR(12) NOT NULL
	)
 
;

CREATE TABLE `Expectativas Estudiantes` (
		`Año` DATE NOT NULL, 
		`Expectativa Académica` DOUBLE, 
		`Comunicación` DOUBLE, 
		`Participación` DOUBLE, 
...
CREATE TABLE `Expectativas Institución Educativa` (
		`Año` DATE NOT NULL, 
		`Expectativa Académica` DOUBLE, 
		`Comunicación` DOUBLE, 
		`Participación` DOUBLE, 
		`Seguridad y Respeto` DOUBLE, 
		`Código DANE` CHAR(12) NOT NULL, 
		`Ambiente Escolar` DOUBLE, 
		`VII Total` DOUBLE
	)
 
;

CREATE TABLE `Expectativas Padres` (
		`Año` DATE NOT NULL, 
		`Expectativa Académica` DOUBLE, 
		`Comunicación` DOUBLE, 
		`Participación` DOUBLE, 
...
CREATE TABLE `Institución Educativa` (
		`Código DANE` CHAR(12) NOT NULL, 
...
ALTER TABLE `Encuesta Docentes` ADD CONSTRAINT `Encuesta Docentes_PK` PRIMARY KEY
	(`Código DANE`, 
	 `Código Sede`, 
	 `Año`, 
	 `ID`);

ALTER TABLE `Encuesta Estudiantes` ADD CONSTRAINT `Encuesta Estudiantes_PK` PRIMARY KEY
	(`Código DANE`, 
	 `Código Sede`, 
	 `Año`, 
	 `ID`);

ALTER TABLE `Encuesta Padres` ADD CONSTRAINT `Encuesta Padres_PK` PRIMARY KEY
	(`Código DANE`, 
	 `Código Sede`, 
	 `Año`, 
	 `ID`);

ALTER TABLE `Expectativas Docentes` ADD CONSTRAINT `Expectativas Padres_PK` PRIMARY KEY
	(`Código DANE`, 
	 `Año`);

ALTER TABLE `Expectativas Estudiantes` ADD CONSTRAINT `Expectativas Padres_PK` PRIMARY KEY
	(`Código DANE`, 
	 `Año`);

ALTER TABLE `Expectativas Institución Educativa` ADD CONSTRAINT `Expectativas Padres_PK` PRIMARY KEY
	(`Código DANE`, 
	 `Año`);

ALTER TABLE `Expectativas Padres` ADD CONSTRAINT `Expectativas Padres_PK` PRIMARY KEY
	(`Código DANE`, 
	 `Año`);
...
ALTER TABLE `Institución Educativa` ADD CONSTRAINT `Institución Educativa_PK` PRIMARY KEY
	(`Código DANE`);
...
ALTER TABLE `Clusters` ADD CONSTRAINT `Clulsters_Institución Educativa_FK` FOREIGN KEY
	(`Código DANE`)
	REFERENCES `Institución Educativa`
	(`Código DANE`)
	ON DELETE CASCADE;
...
ALTER TABLE `Encuesta Docentes` ADD CONSTRAINT `Encuesta Docentes_Sede_FK` FOREIGN KEY
	(`Código DANE`, 
	 `Código Sede`)
	REFERENCES `Sede`
	(`Código DANE`, 
...
ALTER TABLE `Encuesta Estudiantes` ADD CONSTRAINT `Encuesta Estudiantes_Sede_FK` FOREIGN KEY
	(`Código DANE`, 
	 `Código Sede`)
	REFERENCES `Sede`
	(`Código DANE`, 
...
ALTER TABLE `Encuesta Padres` ADD CONSTRAINT `Encuesta Padres_Sede_FK` FOREIGN KEY
	(`Código DANE`, 
	 `Código Sede`)
	REFERENCES `Sede`
	(`Código DANE`, 
...
ALTER TABLE `Expectativas Docentes` ADD CONSTRAINT `Expectativas Docentes_Institución Educativa_FK` FOREIGN KEY
	(`Código DANE`)
	REFERENCES `Institución Educativa`
	(`Código DANE`)
	ON DELETE CASCADE;

ALTER TABLE `Expectativas Estudiantes` ADD CONSTRAINT `Expectativas Estudiantes_Institución Educativa_FK` FOREIGN KEY
	(`Código DANE`)
	REFERENCES `Institución Educativa`
	(`Código DANE`)
	ON DELETE CASCADE;

ALTER TABLE `Expectativas Institución Educativa` ADD CONSTRAINT `Expectativas Institución Educativa_Institución Educativa_FK` FOREIGN KEY
	(`Código DANE`)
	REFERENCES `Institución Educativa`
	(`Código DANE`)
	ON DELETE CASCADE;

ALTER TABLE `Expectativas Padres` ADD CONSTRAINT `Expectativas Padres_Institución Educativa_FK` FOREIGN KEY
	(`Código DANE`)
	REFERENCES `Institución Educativa`
	(`Código DANE`)
	ON DELETE CASCADE;
...
ALTER TABLE `Indice Aprendizaje Eficiencia` ADD CONSTRAINT `Indice_Aprendizaje_Eficiencia_Institución Educativa_FK` FOREIGN KEY
	(`Código DANE`)
	REFERENCES `Institución Educativa`
	(`Código DANE`)
	ON DELETE CASCADE;

ALTER TABLE `Institución Educativa` ADD CONSTRAINT `Institución Educativa_Departamentos_FK` FOREIGN KEY
	(`Código Departamento`)
	REFERENCES `Departamentos`
	(`Código Departamento`)
	ON DELETE RESTRICT;

ALTER TABLE `Institución Educativa` ADD CONSTRAINT `Institución Educativa_Jornadas_FK` FOREIGN KEY
	(`Código Jornada`)
	REFERENCES `Jornadas`
	(`Código Jornada`)
	ON DELETE RESTRICT;

ALTER TABLE `Institución Educativa` ADD CONSTRAINT `Institución Educativa_Municipios_FK` FOREIGN KEY
	(`Código Municipio`)
	REFERENCES `Municipios`
	(`Código Municipio`)
	ON DELETE RESTRICT;

ALTER TABLE `Institución Educativa` ADD CONSTRAINT `Institución Educativa_Naturalezas_FK` FOREIGN KEY
	(`Código Naturaleza`)
	REFERENCES `Naturalezas`
	(`Código Naturaleza`)
	ON DELETE RESTRICT;

ALTER TABLE `Institución Educativa` ADD CONSTRAINT `Institución Educativa_Zonas_FK` FOREIGN KEY
	(`Código Zona`)
	REFERENCES `Zonas`
	(`Código Zona`)
	ON DELETE RESTRICT;
