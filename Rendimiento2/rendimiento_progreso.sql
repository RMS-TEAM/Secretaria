...
--
-- Servidor: localhost
-- Tiempo de generación: 21-12-2011 a las 16:25:39
...
--
-- Base de datos: `rendimiento_progreso2`
--
...
CREATE TABLE IF NOT EXISTS `indicadores` (
  ...
  `ProporcionEstrato0` decimal(8,5) DEFAULT NULL,
  `ProporcionEstrato1` decimal(8,5) DEFAULT NULL,
  `ProporcionEstrato2` decimal(8,5) DEFAULT NULL,
  `ProporcionEstrato3` decimal(8,5) DEFAULT NULL,
  `ProporcionEstrato4` decimal(8,5) DEFAULT NULL,
  `ProporcionEstrato5` decimal(8,5) DEFAULT NULL,
  `ProporcionEstrato6` decimal(8,5) DEFAULT NULL,
  ...
  `prmat_bajo_10` decimal(8,5) DEFAULT NULL,
  `prmat_medio_10` decimal(8,5) DEFAULT NULL,
  `prmat_alto_10` decimal(8,5) DEFAULT NULL,
  `prlen_bajo_10` decimal(8,5) DEFAULT NULL,
  `prlen_medio_10` decimal(8,5) DEFAULT NULL,
  `prlen_alto_10` decimal(8,5) DEFAULT NULL,
  `prmat_bajo_10_p` decimal(8,5) DEFAULT NULL,
  `prmat_medio_10_p` decimal(8,5) DEFAULT NULL,
  `prmat_alto_10_p` decimal(8,5) DEFAULT NULL,
  `prlen_bajo_10_p` decimal(8,5) DEFAULT NULL,
  `prlen_medio_10_p` decimal(8,5) DEFAULT NULL,
  `prlen_alto_10_p` decimal(8,5) DEFAULT NULL,
  ...
  `textra` decimal(8,5) DEFAULT NULL,
  `rtextra` decimal(8,5) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `indicadores_5_9` (
  ...
  `aprobacion5` decimal(8,5) DEFAULT NULL,
  `aprobacion9` decimal(8,5) DEFAULT NULL,
  `permed50len_5` int(2) DEFAULT NULL,
  `permedlen33_5` int(2) DEFAULT NULL,
  `permed50len_9` int(2) DEFAULT NULL,
  `permedlen33_9` int(2) DEFAULT NULL,
  `permed50mat_5` int(2) DEFAULT NULL,
  `permedmat33_5` int(2) DEFAULT NULL,
  `permed50mat_9` int(2) DEFAULT NULL,
  `permedmat33_9` int(2) DEFAULT NULL,
  `nombre` varchar(80) COLLATE latin1_spanish_ci DEFAULT NULL,
  `nombre_sb11_10` varchar(80) COLLATE latin1_spanish_ci DEFAULT NULL,
  `nombre_sb11_07` varchar(80) COLLATE latin1_spanish_ci DEFAULT NULL,
  `ProporcionEstrato0` decimal(8,5) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `indicadores_11` (
  `dane` bigint(12) NOT NULL,
  `nombre` varchar(80) COLLATE latin1_spanish_ci DEFAULT NULL,
  `nombre_sb11_10` varchar(80) COLLATE latin1_spanish_ci NOT NULL,
  `nombre_sb11_07` varchar(80) COLLATE latin1_spanish_ci NOT NULL,
  `ProporcionEstrato0` decimal(8,5) NOT NULL,
  `ProporcionEstrato1` decimal(8,5) NOT NULL,
  `ProporcionEstrato2` decimal(8,5) NOT NULL,
  `ProporcionEstrato3` decimal(8,5) NOT NULL,
  `ProporcionEstrato4` decimal(8,5) NOT NULL,
  `ProporcionEstrato5` decimal(8,5) NOT NULL,
  `ProporcionEstrato6` decimal(8,5) NOT NULL,
  `tema_matematica` decimal(8,5) DEFAULT NULL,
  `tema_lenguaje` decimal(8,5) DEFAULT NULL,
  `prmat_bajo_07` decimal(8,5) DEFAULT NULL,
  `prmat_medio_07` decimal(8,5) DEFAULT NULL,
