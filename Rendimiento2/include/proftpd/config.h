...
#define PR_BUILD_OPTS " '--prefix=/opt/lampp' '--with-modules=mod_sql:mod_sql_mysql:mod_tls' '--with-includes=/opt/lampp/include/mysql:/opt/lampp/include:/opt/lampp/include/ncurses' '--with-libraries=/opt/lampp/lib/mysql' 'CFLAGS=-O6 -I/opt/lampp/include/ncurses -L/opt/lampp/lib' 'LDFLAGS=-Wl,--rpath -Wl,/opt/lampp/lib -Wl,--rpath -Wl,/opt/lampp/lib/mysql -L/opt/lampp/lib'"

/* Define to be the build CFLAGS.  */
#define PR_BUILD_CFLAGS "-O6 -I/opt/lampp/include/ncurses -L/opt/lampp/lib -Wall"

/* Define to be the build LDLAGS.  */
#define PR_BUILD_LDFLAGS "-L$(top_srcdir)/lib -Wl,--rpath -Wl,/opt/lampp/lib -Wl,--rpath -Wl,/opt/lampp/lib/mysql -L/opt/lampp/lib -L/opt/lampp/lib/mysql"
