cd "/home/sebastian/rendimiento/DTA files"

use "tabla identificadores.dta", clear
outsheet using "/home/sebastian/rendimiento/SQL/tabla identificadores.csv", comma replace
...
use "saber_5y9_09.dta", clear
outsheet using "/home/sebastian/rendimiento/SQL/saber_5y9_09.csv", comma replace
gen l5r = (l5-100)/4
gen m5r = (m5-100)/4
gen cn5r = (cn5-100)/4
gen l9r = (l9-100)/4
...
outsheet using "/home/sebastian/rendimiento/SQL/escala5_9_09.csv", comma replace

***Tasa de aprobación de grados 5°, 9° y 11°***
use "eficiencia_interna_oficial c600.dta", clear
outsheet using "/home/sebastian/rendimiento/SQL/eficiencia_interna_oficial c600.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/rev1.csv", comma replace
save taprob, replace
outsheet using "/home/sebastian/rendimiento/SQL/taprob.csv", comma replace
...
***La tasa extraedad para los grados 5 y 9 no se calculo ya que no se posee informacion de los alumnos que aprobaron estos grados***
 ...
 outsheet using "/home/sebastian/rendimiento/SQL/sb11-2010-2-rgstro-clfccn-v1,.csv", comma replace
 ...
 save rev2, replace
 outsheet using "/home/sebastian/rendimiento/SQL/rev2.csv", comma replace
 ...
 save textra,replace
 outsheet using "/home/sebastian/rendimiento/SQL/textra.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/sb11-2007-2-rgstro-clfccn-v-1-0.csv", comma replace
...
save rev3, replace
outsheet using "/home/sebastian/rendimiento/SQL/rev3.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/mediana11_07.csv", comma replace
...
drop if cole_codigo_mcpio_d != 5001
save rev4, replace
outsheet using "/home/sebastian/rendimiento/SQL/rev4.csv", comma replace
collapse (median) tema_lenguaje_d tema_matematica_d, by(cole_inst_nombre)
rename cole_inst_nombre nombre_sb11_10
save mediana11_10, replace
outsheet using "/home/sebastian/rendimiento/SQL/mediana11_10.csv", comma replace
...
save rev5, replace
outsheet using "/home/sebastian/rendimiento/SQL/rev5.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/pr_estudiantes_07.csv", comma replace
...
save rev6, replace
outsheet using "/home/sebastian/rendimiento/SQL/rev6.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/pr_estudiantes_10.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/saber_5y9_03.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/permed_5_9_03.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/permedianocr.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/permed11_07.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/permedianocr11.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/sb11-clasifi-planteles-2007-v-1-0.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/ran_ie07.csv", comma replace

use "sb11-clasifi-planteles-2010-v-1-0.dta", clear
outsheet using "/home/sebastian/rendimiento/SQL/sb11-clasifi-planteles-2010-v-1-0.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/ran_ie10.csv", comma replace

merge 1:1 dane using "ran_ie07.dta"
gen varcolegios11 = categoria_10-categoria_07
drop _merge
save varcolegios11, replace
outsheet using "/home/sebastian/rendimiento/SQL/varcolegios11.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/Informeestudiantegrado10y11.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/bonus11.csv", comma replace

use "Informe_estudiante_grado_5", clear
format dane %15.0g
save Informe_estudiante_grado_5, replace
outsheet using "/home/sebastian/rendimiento/SQL/Informe_estudiante_grado_5.csv", comma replace
...
save bonus5,replace 
outsheet using "/home/sebastian/rendimiento/SQL/bonus5.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/res_5_9.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/indicadores_5_9.csv", comma replace
...
drop _merge
save res111, replace
outsheet using "/home/sebastian/rendimiento/SQL/res111.csv", comma replace
...
drop _merge
save res211, replace
outsheet using "/home/sebastian/rendimiento/SQL/res211.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/res211_07.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/res311_07.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/res11_07.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/res211_10.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/res311_10.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/res11_10.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/res11_11.csv", comma replace
...
format %15.0g dane
save res11, replace
outsheet using "/home/sebastian/rendimiento/SQL/res11.csv", comma replace
...
format %15.0g dane
save res11i, replace
outsheet using "/home/sebastian/rendimiento/SQL/res11i.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/res11ii.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/indicadores_11.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/indicadores.csv", comma replace
...
format %15.0g dane
save bonus, replace
outsheet using "/home/sebastian/rendimiento/SQL/bonus.csv", comma replace
...
outsheet using "/home/sebastian/rendimiento/SQL/indicadores_y_bonus.csv", comma replace
