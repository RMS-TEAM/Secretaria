...
BEGIN
	...
	CREATE TABLE `clone_estudiantes` (SELECT * FROM `aeestudiantes`);	

	#-- Invertir las preguntas que estan formuladas de forma incorrecta

	UPDATE `clone_estudiantes` SET `vi_6` = 5 - `vi_6`;
	UPDATE `clone_estudiantes` SET `vi_7` = 5 - `vi_7`;
	UPDATE `clone_estudiantes` SET `vi_8` = 5 - `vi_8`;

	UPDATE `clone_estudiantes` SET `v_14` = 6 - `v_14`;
	UPDATE `clone_estudiantes` SET `v_15` = 5 - `v_15`;	

	UPDATE `clone_estudiantes` SET `vi_11` = 5 - `vi_11`;
	UPDATE `clone_estudiantes` SET `vi_12` = 5 - `vi_12`;
	UPDATE `clone_estudiantes` SET `vi_13` = 5 - `vi_13`;
	UPDATE `clone_estudiantes` SET `vi_14` = 5 - `vi_14`;
	UPDATE `clone_estudiantes` SET `vi_15` = 5 - `vi_15`;
	UPDATE `clone_estudiantes` SET `vi_16` = 5 - `vi_16`;


	# Sección III

	#-- A la pregunta III.7 solo se deben considerar las respuestas de los AEEstudiantes de grado 11. Se excluyen respuestas de grado 5 y 9.

#-----------------------------------------
#
#	tab ii_2,m
#	replace iii_7=. if ii_2==10 | ii_2==9
#	tab iii_7,m
#	tab iii_7 ii_2,m
#
#-----------------------------------------

	ALTER TABLE  `clone_estudiantes` CHANGE  `iii_1`  `iii_1` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `iii_2`  `iii_2` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `iii_3`  `iii_3` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `iii_4`  `iii_4` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `iii_5`  `iii_5` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `iii_6`  `iii_6` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `iii_7`  `iii_7` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `iii_8`  `iii_8` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `iii_9`  `iii_9` DOUBLE;
	...
	# Sección IV
	ALTER TABLE  `clone_estudiantes` CHANGE  `iv_1`  `iv_1` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `iv_2`  `iv_2` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `iv_3`  `iv_3` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `iv_4`  `iv_4` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `iv_5`  `iv_5` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `iv_6`  `iv_6` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `iv_7`  `iv_7` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `iv_8`  `iv_8` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `iv_9`  `iv_9` DOUBLE;
	...
	UPDATE `clone_estudiantes` SET `iv_9`=10/3*(`iv_9`-1);
	...
	# Sección V
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_1`  `v_1` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_2`  `v_2` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_3`  `v_3` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_4`  `v_4` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_5`  `v_5` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_6`  `v_6` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_7`  `v_7` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_8`  `v_8` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_9`  `v_9` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_10`  `v_10` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_11_a`  `v_11_a` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_11_b`  `v_11_b` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_11_c`  `v_11_c` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_11_d`  `v_11_d` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_12`  `v_12` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_13`  `v_13` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_14`  `v_14` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `v_15`  `v_15` DOUBLE;
	...
	# Sección VI
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_1`  `vi_1` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_2`  `vi_2` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_3`  `vi_3` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_4`  `vi_4` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_5`  `vi_5` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_6`  `vi_6` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_7`  `vi_7` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_8`  `vi_8` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_9`  `vi_9` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_10`  `vi_10` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_11`  `vi_11` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_12`  `vi_12` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_13`  `vi_13` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_14`  `vi_14` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_15`  `vi_15` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_16`  `vi_16` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_17`  `vi_17` DOUBLE;
	ALTER TABLE  `clone_estudiantes` CHANGE  `vi_18`  `vi_18` DOUBLE;
	...
	# Sección VII
	ALTER TABLE  `clone_estudiantes` CHANGE  `vii_1`  `vii_1` DOUBLE;
	...
	#--------------------------------------------------------------
	DROP TABLE IF EXISTS `clone_estudiantes1`;
	CREATE TABLE `clone_estudiantes1` 
	SELECT `dane`, `ano`, SUM(iii_1) AS iii_1_re_e, SUM(iii_2) AS iii_2_re_e, SUM(iii_3) AS iii_3_re_e,
	 SUM(iii_4) AS iii_4_re_e, SUM(iii_5) AS iii_5_re_e, SUM(iii_6) AS iii_6_re_e, 
	 SUM(iii_7) AS iii_7_re_e, SUM(iii_8) AS iii_8_re_e, SUM(iii_9) AS iii_9_re_e,
	 SUM(iv_1) AS iv_1_re_e, SUM(iv_2) AS iv_2_re_e, SUM(iv_3) AS iv_3_re_e,
	 SUM(iv_4) AS iv_4_re_e, SUM(iv_5) AS iv_5_re_e, SUM(iv_6) AS iv_6_re_e,
	 SUM(iv_7) AS iv_7_re_e, SUM(iv_8) AS iv_8_re_e, SUM(iv_9) AS iv_9_re_e,
	 SUM(v_1) AS v_1_re_e, SUM(v_2) AS v_2_re_e, SUM(v_3) AS v_3_re_e,
	 SUM(v_4) AS v_4_re_e, SUM(v_5) AS v_5_re_e, SUM(v_6) AS v_6_re_e,
	 SUM(v_7) AS v_7_re_e, SUM(v_8) AS v_8_re_e, SUM(v_9) AS v_9_re_e,
	 SUM(v_10) AS v_10_re_e, SUM(v_11_a) AS v_11_a_re_e, SUM(v_11_b) AS v_11_b_re_e,
	 SUM(v_11_c) AS v_11_c_re_e, SUM(v_11_d) AS v_11_d_re_e, SUM(v_12) AS v_12_re_e,
	 SUM(v_13) AS v_13_re_e, SUM(v_14) AS v_14_re_e, SUM(v_15) AS v_15_re_e,
	 SUM(vi_1) AS vi_1_re_e, SUM(vi_2) AS vi_2_re_e, SUM(vi_3) AS vi_3_re_e,
	 SUM(vi_4) AS vi_4_re_e, SUM(vi_5) AS vi_5_re_e, SUM(vi_6) AS vi_6_re_e,
	 SUM(vi_7) AS vi_7_re_e, SUM(vi_8) AS vi_8_re_e, SUM(vi_9) AS vi_9_re_e,
	 SUM(vi_10) AS vi_10_re_e, SUM(vi_11) AS vi_11_re_e, SUM(vi_12) AS vi_12_re_e,
	 SUM(vi_13) AS vi_13_re_e, SUM(vi_14) AS vi_14_re_e, SUM(vi_15) AS vi_15_re_e,
	 SUM(vi_16) AS vi_16_re_e, SUM(vi_17) AS vi_17_re_e, SUM(vi_18) AS vi_18_re_e,
	 SUM(vii_1) AS vii_1_re_e,
	 COUNT(f_iii_1_re_e) AS f_iii_1_re_e, COUNT(f_iii_2_re_e) AS f_iii_2_re_e, 
	 COUNT(f_iii_3_re_e) AS f_iii_3_re_e, COUNT(f_iii_4_re_e) AS f_iii_4_re_e,
	 COUNT(f_iii_5_re_e) AS f_iii_5_re_e, COUNT(f_iii_6_re_e) AS f_iii_6_re_e,
	 COUNT(f_iii_7_re_e) AS f_iii_7_re_e, COUNT(f_iii_8_re_e) AS f_iii_8_re_e,
	 COUNT(f_iii_9_re_e) AS f_iii_9_re_e, COUNT(f_iv_1_re_e) AS f_iv_1_re_e,
	 COUNT(f_iv_2_re_e) AS f_iv_2_re_e, COUNT(f_iv_3_re_e) AS f_iv_3_re_e,
	 COUNT(f_iv_4_re_e) AS f_iv_4_re_e, COUNT(f_iv_5_re_e) AS f_iv_5_re_e,
	 COUNT(f_iv_6_re_e) AS f_iv_6_re_e, COUNT(f_iv_7_re_e) AS f_iv_7_re_e,
	 COUNT(f_iv_8_re_e) AS f_iv_8_re_e, COUNT(f_iv_9_re_e) AS f_iv_9_re_e,
	 COUNT(f_v_1_re_e) AS f_v_1_re_e, COUNT(f_v_2_re_e) AS f_v_2_re_e,
	 COUNT(f_v_3_re_e) AS f_v_3_re_e, COUNT(f_v_4_re_e) AS f_v_4_re_e,
	 COUNT(f_v_5_re_e) AS f_v_5_re_e, COUNT(f_v_6_re_e) AS f_v_6_re_e,
	 COUNT(f_v_7_re_e) AS f_v_7_re_e, COUNT(f_v_8_re_e) AS f_v_8_re_e,
	 COUNT(f_v_9_re_e) AS f_v_9_re_e, COUNT(f_v_10_re_e) AS f_v_10_re_e,
	 COUNT(f_v_11_a_re_e) AS f_v_11_a_re_e, COUNT(f_v_11_b_re_e) AS f_v_11_b_re_e,
	 COUNT(f_v_11_c_re_e) AS f_v_11_c_re_e, COUNT(f_v_11_d_re_e) AS f_v_11_d_re_e,
	 COUNT(f_v_12_re_e) AS f_v_12_re_e, COUNT(f_v_13_re_e) AS f_v_13_re_e,
	 COUNT(f_v_14_re_e) AS f_v_14_re_e, COUNT(f_v_15_re_e) AS f_v_15_re_e,
	 COUNT(f_vi_1_re_e) AS f_vi_1_re_e, COUNT(f_vi_2_re_e) AS f_vi_2_re_e,
	 COUNT(f_vi_3_re_e) AS f_vi_3_re_e, COUNT(f_vi_4_re_e) AS f_vi_4_re_e,
	 COUNT(f_vi_5_re_e) AS f_vi_5_re_e, COUNT(f_vi_6_re_e) AS f_vi_6_re_e,
	 COUNT(f_vi_7_re_e) AS f_vi_7_re_e, COUNT(f_vi_8_re_e) AS f_vi_8_re_e,
	 COUNT(f_vi_9_re_e) AS f_vi_9_re_e, COUNT(f_vi_10_re_e) AS f_vi_10_re_e,
	 COUNT(f_vi_11_re_e) AS f_vi_11_re_e, COUNT(f_vi_12_re_e) AS f_vi_12_re_e,
	 COUNT(f_vi_13_re_e) AS f_vi_13_re_e, COUNT(f_vi_14_re_e) AS f_vi_14_re_e,
	 COUNT(f_vi_15_re_e) AS f_vi_15_re_e, COUNT(f_vi_16_re_e) AS f_vi_16_re_e,
	 COUNT(f_vi_17_re_e) AS f_vi_17_re_e, COUNT(f_vi_18_re_e) AS f_vi_18_re_e,
	 COUNT(f_vii_1_re_e) AS f_vii_1_re_e
	...
	# Sección III
	ALTER TABLE `clone_estudiantes1` ADD `pro_iii_1_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_iii_2_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_iii_3_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_iii_4_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_iii_5_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_iii_6_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_iii_7_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_iii_8_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_iii_9_re_e` DOUBLE;

	UPDATE `clone_estudiantes1` SET `pro_iii_1_re_e`=`iii_1_re_e`/`f_iii_1_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_iii_2_re_e`=`iii_2_re_e`/`f_iii_2_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_iii_3_re_e`=`iii_3_re_e`/`f_iii_3_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_iii_4_re_e`=`iii_4_re_e`/`f_iii_4_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_iii_5_re_e`=`iii_5_re_e`/`f_iii_5_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_iii_6_re_e`=`iii_6_re_e`/`f_iii_6_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_iii_7_re_e`=`iii_7_re_e`/`f_iii_7_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_iii_8_re_e`=`iii_8_re_e`/`f_iii_8_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_iii_9_re_e`=`iii_9_re_e`/`f_iii_9_re_e`;

	# Seccion IV
	ALTER TABLE `clone_estudiantes1` ADD `pro_iv_1_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_iv_2_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_iv_3_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_iv_4_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_iv_5_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_iv_6_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_iv_7_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_iv_8_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_iv_9_re_e` DOUBLE;

	UPDATE `clone_estudiantes1` SET `pro_iv_1_re_e`=`iv_1_re_e`/`f_iv_1_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_iv_2_re_e`=`iv_2_re_e`/`f_iv_2_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_iv_3_re_e`=`iv_3_re_e`/`f_iv_3_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_iv_4_re_e`=`iv_4_re_e`/`f_iv_4_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_iv_5_re_e`=`iv_5_re_e`/`f_iv_5_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_iv_6_re_e`=`iv_6_re_e`/`f_iv_6_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_iv_7_re_e`=`iv_7_re_e`/`f_iv_7_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_iv_8_re_e`=`iv_8_re_e`/`f_iv_8_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_iv_9_re_e`=`iv_9_re_e`/`f_iv_9_re_e`;

	# Sección V
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_1_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_2_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_3_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_4_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_5_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_6_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_7_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_8_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_9_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_10_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_11_a_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_11_b_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_11_c_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_11_d_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_12_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_13_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_14_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_v_15_re_e` DOUBLE;

	UPDATE `clone_estudiantes1` SET `pro_v_1_re_e`=`v_1_re_e`/`f_v_1_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_2_re_e`=`v_2_re_e`/`f_v_2_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_3_re_e`=`v_3_re_e`/`f_v_3_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_4_re_e`=`v_4_re_e`/`f_v_4_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_5_re_e`=`v_5_re_e`/`f_v_5_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_6_re_e`=`v_6_re_e`/`f_v_6_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_7_re_e`=`v_7_re_e`/`f_v_7_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_8_re_e`=`v_8_re_e`/`f_v_8_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_9_re_e`=`v_9_re_e`/`f_v_9_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_10_re_e`=`v_10_re_e`/`f_v_10_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_11_a_re_e`=`v_11_a_re_e`/`f_v_11_a_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_11_b_re_e`=`v_11_b_re_e`/`f_v_11_b_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_11_c_re_e`=`v_11_c_re_e`/`f_v_11_c_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_11_d_re_e`=`v_11_d_re_e`/`f_v_11_d_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_12_re_e`=`v_12_re_e`/`f_v_12_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_13_re_e`=`v_13_re_e`/`f_v_13_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_14_re_e`=`v_14_re_e`/`f_v_14_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_v_15_re_e`=`v_15_re_e`/`f_v_15_re_e`;

	# Sección VI
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_1_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_2_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_3_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_4_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_5_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_6_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_7_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_8_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_9_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_10_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_11_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_12_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_13_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_14_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_15_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_16_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_17_re_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `pro_vi_18_re_e` DOUBLE;

	UPDATE `clone_estudiantes1` SET `pro_vi_1_re_e`=`vi_1_re_e`/`f_vi_1_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_2_re_e`=`vi_2_re_e`/`f_vi_2_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_3_re_e`=`vi_3_re_e`/`f_vi_3_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_4_re_e`=`vi_4_re_e`/`f_vi_4_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_5_re_e`=`vi_5_re_e`/`f_vi_5_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_6_re_e`=`vi_6_re_e`/`f_vi_6_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_7_re_e`=`vi_7_re_e`/`f_vi_7_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_8_re_e`=`vi_8_re_e`/`f_vi_8_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_9_re_e`=`vi_9_re_e`/`f_vi_9_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_10_re_e`=`vi_10_re_e`/`f_vi_10_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_11_re_e`=`vi_11_re_e`/`f_vi_11_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_12_re_e`=`vi_12_re_e`/`f_vi_12_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_13_re_e`=`vi_13_re_e`/`f_vi_13_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_14_re_e`=`vi_14_re_e`/`f_vi_14_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_15_re_e`=`vi_15_re_e`/`f_vi_15_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_16_re_e`=`vi_16_re_e`/`f_vi_16_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_17_re_e`=`vi_17_re_e`/`f_vi_17_re_e`;
	UPDATE `clone_estudiantes1` SET `pro_vi_18_re_e`=`vi_18_re_e`/`f_vi_18_re_e`;

	# Sección VII
	ALTER TABLE `clone_estudiantes1` ADD `pro_vii_1_re_e` DOUBLE;

	UPDATE `clone_estudiantes1` SET `pro_vii_1_re_e`=`vii_1_re_e`/`f_vii_1_re_e`;


	#-- Medias por pregunta
	#-- Se excluye el promedio de la pregunta pro_v_15_re_e, pues la pregunta 14 y 15 de la sección 5 son similares, se deja la que pregunta de forma mas especifica
	#-- Se excluyen las preguntas V11a, V11b y V11c, puesto que no es claro qué tan bueno es cada opción. Lo ideal es que se haga trabajo en grupo en la IE.
	#-------------------------------
	#   egen rowmean	       |
	#-------------------------------

	ALTER TABLE `clone_estudiantes1` ADD `III_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `IV_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `V_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `VI_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `VII_e` DOUBLE;
	ALTER TABLE `clone_estudiantes1` ADD `Ambi_escol_e` DOUBLE;

	UPDATE `clone_estudiantes1` SET `III_e` = (pro_iii_1_re_e + pro_iii_2_re_e + pro_iii_3_re_e + pro_iii_4_re_e 
	 + pro_iii_5_re_e + pro_iii_6_re_e + pro_iii_7_re_e + pro_iii_8_re_e + pro_iii_9_re_e) / 9;

	UPDATE `clone_estudiantes1` SET `IV_e` = (pro_iv_1_re_e + pro_iv_2_re_e + pro_iv_3_re_e + pro_iv_4_re_e
	 + pro_iv_5_re_e + pro_iv_6_re_e + pro_iv_7_re_e + pro_iv_8_re_e) / 8;

	UPDATE `clone_estudiantes1` SET `V_e` = (pro_v_1_re_e + pro_v_2_re_e + pro_v_3_re_e + pro_v_4_re_e
	...
	UPDATE `clone_estudiantes1` SET `VI_e` = (pro_vi_1_re_e + pro_vi_2_re_e + pro_vi_3_re_e + pro_vi_4_re_e
	...
	UPDATE `clone_estudiantes1` SET `VII_e` = (pro_vii_1_re_e) / 1;

	UPDATE `clone_estudiantes1` SET `Ambi_escol_e` = (III_e + IV_e + V_e + VI_e) / 4;


	DELETE FROM `aeestudiantes1`;
	INSERT INTO `aeestudiantes1` (dane, EAcademicasEstudiantes, ComunicacionEstudiantes, ParticipacionEstudiantes, SeguridadResEstudiantes, VII_e, Ambi_escol_e, ano) 
	SELECT `dane`, III_e, IV_e, V_e, VI_e, VII_e, Ambi_escol_e, ano
	FROM `clone_estudiantes1`;

	DROP TABLE `clone_estudiantes1`;
